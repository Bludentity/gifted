...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~zyImwIrI#IS1VtO6WfHqwsC6cWJhd5gBgzOihPqiq16J-owGzF4o", // Add sess Id here especially when deploying on panels else use app.json and .env file...
